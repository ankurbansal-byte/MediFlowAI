...
const SidebarV5_1: React.FC<SidebarV5_1Props> = ({
  onLogout,
  ...
  return (
    <aside className={`sidebar sidebar--v5_1 ${isCollapsed ? "sidebar--collapsed" : ""}`} aria-label="Primary navigation">
      {/* Brand & Context */}
      <div className="sidebar__brand-container">
        ...
        {!isCollapsed && (
          <div className="sidebar__role-context" style={{ display: "flex", alignItems: "center", gap: "6px", marginTop: "6px", border: "none", background: "transparent", padding: 0 }}>
            <span style={{ display: "inline-block", width: "6px", height: "6px", borderRadius: "50%", background: "var(--v5-brand-green)" }}></span>
            <span style={{ fontSize: "10px", fontWeight: 600, letterSpacing: "0.05em", color: "var(--v5-text-muted)", textTransform: "uppercase" }}>AI Health</span>
            <span style={{ color: "var(--v5-border-subtle)", fontSize: "10px" }}>•</span>
            <span style={{ fontSize: "10px", fontWeight: 600, letterSpacing: "0.05em", color: "var(--v5-brand-green)", textTransform: "uppercase" }}>WhatsApp Connected</span>
          </div>
        )}
      </div>
      ...
      {onToggleCollapse && (
        <button
          ...
          style={{ margin: "12px 20px 8px 20px", background: "none", border: "1px solid var(--v51-sidebar-border)", borderRadius: "6px", cursor: "pointer", padding: "6px 12px", fontSize: "12px", color: "var(--v5-text-dark)", fontWeight: "600" }}
        >
        ...
        {!isCollapsed && onLogoutConfirmTrigger && (
          <button
            ...
            style={{
              ...
              alignItems: "center",
              background: "none",
              border: "1px solid var(--v51-sidebar-border)",
              borderRadius: "8px",
              padding: "10px",
              fontWeight: 600,
