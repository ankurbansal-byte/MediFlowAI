...
import "./Doc2mePitchHeroFinal.css";

interface Doc2mePitchHeroFinalProps {
  onLoginClick?: () => void;
}

const Doc2mePitchHeroFinal: React.FC<Doc2mePitchHeroFinalProps> = ({ onLoginClick }) => {
  const handleLogin = () => {
    if (onLoginClick) {
      onLoginClick();
    } else {
  ...
  return (
    <div className="pitch-final-canvas">
      {/* BACKGROUND GRAPHICS & RADIAL GLOWS */}
      <div className="pitch-final-bg-glows">
        <div className="pitch-final-glow glow-base" />
        <div className="pitch-final-glow glow-center" />
        <div className="pitch-final-glow glow-secondary" />
        <div className="pitch-final-glow glow-accent" />
        <div className="pitch-final-glow glow-highlight" />
        <div className="pitch-final-glow glow-right-glow" /> {/* Dedicated soft radial glow for right-side cards */}
      </div>

      {/* FLOATING WHATSAPP CARDS - BEHIND CONTENT */}
      <div className="pitch-final-floating-cards">
        {/* Card 1: Patient text message (English Sugar) */}
        <div className="pitch-final-card p-card p-card-1">
        ...
        <div className="pitch-final-card ai-card ai-card-1">
        ...
        <div className="pitch-final-card ai-card ai-card-6">
          <div className="p-card-header">Doc2Me AI</div>
          <div className="p-card-body">Voice note processed.</div>
        </div>

        {/* Card 14: WhatsApp Image Message Card */}
        <div className="pitch-final-card image-card">
        ...
        <div className="pitch-final-card ai-card ai-card-7">
          <div className="p-card-header">Doc2Me AI</div>
          <div className="p-card-body">Record saved successfully.</div>
        </div>

        {/* Card 16: Health Summary Card */}
        <div className="pitch-final-card summary-card">
      ...
      <header className="pitch-final-header">
        <div className="header-logo-container">
          <img src="/images/branding/logo-horizontal.png" alt="Doc2Me Logo" className="pitch-final-logo" />
        </div>
        <div className="header-actions">
          <button className="pitch-final-btn-login" onClick={handleLogin}>
            Login
          </button>
          <button className="pitch-final-btn-signup" onClick={handleSignUp}>
            Sign Up
          </button>
        </div>
      </header>
      ...
      <main className="pitch-final-hero-main">
        <div className="pitch-final-hero-content">
          <div className="pitch-final-badge">
            <span className="pitch-final-badge-pulse" />
            <span className="pitch-final-badge-text">100% Secure AI-Powered Health Logging</span>
          </div>

          <h1 className="pitch-final-title">
            The WhatsApp Companion <br />
            <span className="pitch-final-title-gradient">For Your Health Records</span>
          </h1>

          <p className="pitch-final-subtitle">
          ...
          <div className="pitch-final-ctas">
            <button className="pitch-final-cta-primary" onClick={handleSignUp}>
              Launch on WhatsApp
            ...
            <button className="pitch-final-cta-secondary" onClick={handleLogin}>
              See How It Works
            </button>
          </div>
        </div>
...
export default Doc2mePitchHeroFinal;
