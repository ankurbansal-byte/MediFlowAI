  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "20px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "32px" }} className="profile-grid-layout">
        ...
        {/* Left: Quick Search and Queue summary */}
        <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
          ...
          <div style={{
            ...
            <p style={{ margin: "0 0 16px 0", color: "var(--muted, #486581)", fontSize: "0.85rem" }}>
              Instantly search by Patient Name or Patient ID across all of your assigned patients.
            </p>
            ...
            <div className="auth-form-group" style={{ marginBottom: "0" }}>
              <input
                ...
                placeholder="Type Patient ID (e.g. PAT-101) or Name..."
                value={searchQuery}
                ...
                {filteredSearchPatients.length === 0 ? (
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                    {filteredSearchPatients.map((p) => (
                      ...
                      >
                        <div>
                          <strong style={{ color: "#0a2540", fontSize: "0.9rem" }}>{p.fullName}</strong>
                          <span style={{ display: "block", fontSize: "0.75rem", color: "#486581", fontFamily: "monospace" }}>
                            {p.patientId}
                          </span>
                        </div>
                        <button
