  ...
  return (
    <div className="v5-editorial-transition">
      <div className="v5-editorial-divider">
        ...
        {/* Removed star and badge icons */}
        <div className="v5-editorial-line"></div>
      </div>
      <p className="v5-editorial-text">
        {text}
      </p>
      {/* Small medical illustrations placed minimally around the quote */}
      <div className="v5-editorial-props-container">
        {/* Stethoscope */}
        <span title="Stethoscope">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M3 3v10a6 6 0 0 0 12 0V3M21 3v10a3 3 0 0 1-6 0" />
          </svg>
        </span>
        <span style={{ opacity: 0.3 }}>•</span>
        {/* Blood Drop */}
        <span title="Blood Drop">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 21.5c4.5 0 8-3.5 8-8c0-4.5-8-11.5-8-11.5S4 9 4 13.5c0 4.5 3.5 8 8 8z" />
          </svg>
        </span>
        <span style={{ opacity: 0.3 }}>•</span>
        {/* BP Monitor */}
        <span title="BP Monitor">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
interface DashboardViewV5_1Props {
  user: User;
...
const DashboardViewV5_1: React.FC<DashboardViewV5_1Props> = ({
  user,
  effectivePatientId,
  ...
  useEffect(() => {
    if (effectivePatientId) {
      ...
      api.get(`/patient/lab-observations/${effectivePatientId}`)
        ...
        .catch(err => {
          console.error("Error fetching lab observations in DashboardViewV5_1:", err);
          setHasLabsError(true);
        })
        .finally(() => {
  ...
  return (
    <div className="dashboard--v5_1 v5-mediflow-pattern" style={{ display: "flex", flexDirection: "column", gap: "32px", padding: "16px 24px" }}>
              ...
              <div className="v5-journey-card-v5 whatsapp" style={{ padding: "16px", borderRadius: "12px", border: "1.5px solid var(--v5-border-subtle)", background: "var(--v5-bg-white)", borderLeft: "4px solid var(--v5-brand-green)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                  <span style={{
                    ...
                    {/* Official WhatsApp logo representation */}
          ...
          {[
            ...
            return (
              ...
              >
                ...
                {/* ONE Button "View More" (background: #FF8A00, text: White) */}
                <div className="v51-snapshot-btn-container" style={{ position: "relative", zIndex: 1 }}>
                  <button className="v51-view-more-btn" type="button">
                    View More
                  </button>
                </div>
              </div>
        ...
        <div className="v5-today-split">
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "20px" }}>
              ...
              {/* Redesigned Premium Manual Entry button */}
              <button
                onClick={() => setIsModalOpen(true)}
                className="v51-manual-entry-btn"
                type="button"
              >
                + Manual Entry
              </button>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                {/* Official WhatsApp Logo SVG representation */}
                <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" style={{ color: '#FFFFFF' }}>
                  <path d="M12.011 2c-5.502 0-9.989 4.487-9.989 9.989 0 1.761.458 3.473 1.332 4.98L2 22l5.187-1.359c1.464.799 3.11 1.22 4.814 1.22 5.504 0 9.991-4.487 9.991-9.989A9.99 9.99 0 0012.011 2zm6.208 14.154c-.255.718-1.5 1.318-2.059 1.404-.499.077-1.154.144-3.328-.756-2.78-1.15-4.57-3.988-4.71-4.174-.139-.186-1.139-1.514-1.139-2.89 0-1.376.719-2.053.974-2.333.255-.279.558-.349.743-.349H9.3c.186 0 .442-.07.697.54.256.61.872 2.129.948 2.284.075.155.126.335.021.543-.103.208-.155.335-.308.513-.153.178-.322.396-.46.531-.155.15-.318.314-.136.626.182.312.809 1.331 1.734 2.157.925.826 1.707 1.08 2.025 1.213.318.133.504.111.693-.106.189-.217.809-.942 1.025-1.264.217-.322.433-.269.73-.159.297.109 1.886.889 2.213 1.053.328.164.546.244.626.382.081.138.081.802-.174 1.52z"/>
                </svg>
              </div>
              <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              {factualSummaryBlocks.map((block) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Bottom CTA "View More" (background: #FF8A00, text: White) */}
                    <div className="v51-glance-btn-container">
                      <button className="v51-view-more-btn" type="button" style={{ background: '#FF8A00', color: 'white' }}>
                        View More
                      </button>
                    </div>
                  </div>
...
export default DashboardViewV5_1;
