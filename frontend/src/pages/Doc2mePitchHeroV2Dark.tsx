...
import "./Doc2mePitchHeroV2Dark.css";

interface Doc2mePitchHeroV2DarkProps {
  onLoginClick?: () => void;
}

const Doc2mePitchHeroV2Dark: React.FC<Doc2mePitchHeroV2DarkProps> = ({ onLoginClick }) => {
  const handleLogin = () => {
    if (onLoginClick) {
      onLoginClick();
    } else {
  ...
  return (
    <div className="pitch-v2-canvas">
      {/* BACKGROUND GRAPHICS & RADIAL GLOWS */}
      <div className="pitch-v2-bg-glows">
        <div className="pitch-v2-glow glow-base" />
        <div className="pitch-v2-glow glow-center" />
        <div className="pitch-v2-glow glow-secondary" />
        <div className="pitch-v2-glow glow-accent" />
        <div className="pitch-v2-glow glow-highlight" />
      </div>

      {/* FLOATING WHATSAPP CARDS - BEHIND CONTENT */}
      <div className="pitch-v2-floating-cards">
        {/* Card 1: Patient text message (English Sugar) */}
        <div className="pitch-v2-card p-card p-card-1">
        ...
        <div className="pitch-v2-card ai-card ai-card-1">
        ...
        <div className="pitch-v2-card ai-card ai-card-7">
          <div className="p-card-header">Doc2Me AI</div>
          <div className="p-card-body">Record saved successfully.</div>
        </div>

        {/* Card 16: Health Summary Card */}
        <div className="pitch-v2-card summary-card">
      ...
      <header className="pitch-v2-header">
        <div className="header-logo-container">
          <img src="/images/branding/logo-horizontal.png" alt="Doc2Me Logo" className="pitch-v2-logo" />
        </div>
        <div className="header-actions">
          <button className="pitch-v2-btn-login" onClick={handleLogin}>
            Login
          </button>
          <button className="pitch-v2-btn-signup" onClick={handleSignUp}>
            Sign Up
          </button>
        </div>
      </header>
      ...
      <main className="pitch-v2-hero-main">
        <div className="pitch-v2-hero-content">
          <div className="pitch-v2-badge">
            <span className="pitch-v2-badge-pulse" />
            <span className="pitch-v2-badge-text">100% Secure AI-Powered Health Logging</span>
          </div>

          <h1 className="pitch-v2-title">
            The WhatsApp Companion <br />
            <span className="pitch-v2-title-gradient">For Your Health Records</span>
          </h1>

          <p className="pitch-v2-subtitle">
          ...
          <div className="pitch-v2-ctas">
            <button className="pitch-v2-cta-primary" onClick={handleSignUp}>
              Launch on WhatsApp
            ...
            <button className="pitch-v2-cta-secondary" onClick={handleLogin}>
              See How It Works
            </button>
          </div>
        </div>
...
export default Doc2mePitchHeroV2Dark;
