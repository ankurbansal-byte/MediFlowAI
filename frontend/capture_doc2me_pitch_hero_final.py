...
async def capture_screenshot():
    ...
    async with async_playwright() as p:
        ...
        # Route directly to the new Sunrise final design preview
        url = "http://localhost:5173/design-preview/doc2me-pitch-hero-final"
        print(f"Opening {url}...")
        try:
            ...
            screenshot_path = "/home/jules/verification/doc2me_pitch_hero_final.png"
