...
async def capture_screenshot():
    ...
    async with async_playwright() as p:
        ...
        # Route directly to the new Aurora design preview
        url = "http://localhost:5173/design-preview/doc2me-pitch-hero-v3-aurora"
        print(f"Opening {url}...")
        try:
            ...
            screenshot_path = "/home/jules/verification/doc2me_pitch_hero_v3_aurora.png"
