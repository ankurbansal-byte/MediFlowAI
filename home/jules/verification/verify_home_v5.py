...
def run_verification():
    print("\n🚀 Starting E2E verification for MediFlowAI Home V5...")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # ==========================================
            # Step 2: Navigate to V5 Route
            # ==========================================
            print("\n🚀 Navigating to V5 Design Preview Route (/design-preview/home-v5)...")
            page.goto("http://localhost:5173/design-preview/home-v5")
            ...
            # 1. Full-page V5
            print("📸 Capturing V5 Full-page screenshot...")
            page.screenshot(path="/home/jules/verification/v5_home.png", full_page=True)
            print("📸 Captured /home/jules/verification/v5_home.png successfully!")
            ...
            page.evaluate("window.scrollTo(0, 0)")
            time.sleep(0.5)
            page.screenshot(path="/home/jules/verification/v5_hero_sidebar.png")
            ...
            if snapshot_elem.is_visible():
                ...
                time.sleep(0.5)
                page.screenshot(path="/home/jules/verification/v5_snapshot.png")
            ...
            if today_elem.is_visible():
                ...
                time.sleep(0.5)
                page.screenshot(path="/home/jules/verification/v5_today.png")
            ...
            if summary_elem.is_visible():
                ...
                time.sleep(0.5)
                page.screenshot(path="/home/jules/verification/v5_summary.png")
            ...
            if labs_elem.is_visible():
                ...
                time.sleep(0.5)
                page.screenshot(path="/home/jules/verification/v5_labs.png")
            ...
            if cta_elem.is_visible():
                ...
                time.sleep(0.5)
                page.screenshot(path="/home/jules/verification/v5_cta_footer.png")

            print("\n🏁 E2E visual verification completed successfully!")

        except Exception as e:
            print(f"❌ Error encountered during E2E verification: {e}")
            page.screenshot(path="/home/jules/verification/error_screenshot_v5.png")
            print("📸 Captured error_screenshot_v5.png for diagnostics.")
            sys.exit(1)
        finally:
            browser.close()
