...
def run_verification():
    print("\n🚀 Starting E2E verification for MediFlowAI Health Insights V5.2...")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # ==========================================
            # Step 2: Navigate to V5.2 Health Insights Route
            # ==========================================
            print("\n🚀 Navigating to V5.2 Health Insights Design Preview Route (/design-preview/health-insights-v5-2)...")
            page.goto("http://localhost:5173/design-preview/health-insights-v5-2")
            ...
            print("📸 Capturing V5.2 Health Insights Blood Sugar (default) screenshot...")
            page.screenshot(path="home/jules/verification/v5_2_health_insights_blood_sugar.png", full_page=True)
            ...
            time.sleep(1.0)
            page.screenshot(path="home/jules/verification/v5_2_health_insights_blood_pressure.png", full_page=True)

            # Click on Heart Rate selector
            print("❤️ Clicking on Heart Rate Selector...")
            page.click("button:has-text('Heart Rate')")
            time.sleep(1.0)
            page.screenshot(path="home/jules/verification/v5_2_health_insights_heart_rate.png", full_page=True)

            # Save main screenshot to standard location requested/expected
            page.screenshot(path="home/jules/verification/v5_2_health_insights.png", full_page=True)
            print("📸 Captured home/jules/verification/v5_2_health_insights.png successfully!")

            print("\n🏁 E2E visual verification completed successfully!")

        except Exception as e:
            print(f"❌ Error encountered during E2E verification: {e}")
            page.screenshot(path="home/jules/verification/error_screenshot_v5_2_insights.png")
            print("📸 Captured error_screenshot_v5_2_insights.png for diagnostics.")
            sys.exit(1)
        finally:
            browser.close()
